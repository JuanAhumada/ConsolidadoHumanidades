...
consolidado/
  ...
  web/
    ...
    avisos.py                Tarjetas si el .exe falla
    templates/  static/
  gui/                       Escritorio legado
docs/MANUAL_TECNICO.md       Este documento
...
Cada pestaña del menú tiene un **?** (`manual_usuario.py` + overlay `_ayuda.html`). Los fallos de la web se muestran como tarjetas, no como consola.
